...
const Project2 = () => {
    return (
        <div className='mx-auto max-w-[800px] mt-10'>
            ...
            <img className='w-[600px] h-72 mx-auto' src="https://i.ibb.co/3sWxptk/website.jpg" alt="" />
            <hr />
            ...
            <p className='mt-10 font-mono'><span className='font-bold text-xl'>Technology used:</span> React, Tailwind CSS, Node.js, Express.js, Firebase, MongoDB, JWT.</p>
        ...
        Server Code Link
          ...
          <Button variant="contained" color="secondary" style={{ marginRight: '10px' }} href='https://oafish-shoe.surge.sh/'>
        Live Link
          </Button>
            </div>
        </div>
